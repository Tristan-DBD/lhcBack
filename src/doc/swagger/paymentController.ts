...
export class PaymentController {
    ...
    public async toggleMonth(@Body() body: TogglePaymentDto): Promise<PaymentYearSchema> {
        return {} as any
    }
    ...
    @Get('/{userId}')
    @Security('BearerAuth')
    public async getPaymentsByUser(@Path() userId: number): Promise<PaymentYearSchema[]> {
        return [] as any
    }
}
